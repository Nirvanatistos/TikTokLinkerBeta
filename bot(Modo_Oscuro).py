...
def display_chat_window():
    ...
    # Título del chat
    chat_label = tk.Label(chat_frame, text="TikTok Chat", bg="black" , fg="white" , font=("Arial Black", 12, "bold"))
    ...
    if allowed_user:
        ...
        async def on_comment(event: CommentEvent):
            ...
            if comment.strip() and comment not in seen_comments:
                ...
                add_chat_message_func(chat_display, (username, comment), nickname_color="yellow", text_color="white")
